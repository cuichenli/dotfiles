...
in
{
  ...
  home-manager = with pkgs; {
    ...
    users.cuichli = {
      ...
      #     export PATH=$HOME/.diablo/bin:$HOME/.rd/bin:$HOME/.local/bin:$HOME/.krew/bin:/run/current-system/sw/bin/:/$HOME/.cargo/bin:$HOME/go/bin:Users/cuichli/.nimble/bin:$PATH
